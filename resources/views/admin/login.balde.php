<?php
// NOTE: このファイルは拡張子が .blade.php ではないため、routes/admin.php 側で include して返しています。
$error = session('error');
$oldId = old('id', '');
?>
<!doctype html>
        ...
        <section class="auth-card" role="region" aria-label="ログインフォーム">
            ...
            <form class="auth-form" method="post" action="<?= route('admin.login.submit') ?>" novalidate>
                ...
                <div class="auth-field">
                    <label class="auth-label" for="login_id">ID</label>
                    <input
                        id="login_id"
                        name="id"
                        class="auth-input"
                        ...
                        value="<?= htmlspecialchars($oldId, ENT_QUOTES, 'UTF-8') ?>"
                        required />
                </div>
                ...
                <div class="auth-field">
                    ...
                    <div class="auth-inputWrap">
                        <input
                            id="login_password"
                            name="password"
                            class="auth-input auth-input--withBtn"
                            type="password"
